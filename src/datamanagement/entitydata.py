...
TYPE_NONE, TYPE_EXPERIMENTAL, TYPE_SIMULATED, TYPE_SENSITIVITY_OVERVIEW, TYPE_PARAMETERS_ESTIMATED, TYPE_SENSITIVITY_DETAILS_SUBCONDITION, TYPE_SENSITIVITY_DETAILS_JACOBIAN = range(7)
