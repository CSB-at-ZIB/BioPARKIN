...
DEFAULT_PARAMETER_CONSTRAINTS = 0
DEFAULT_PARAMETER_CONSTRAINTS_LOWERBOUND = -1 * float("inf")
DEFAULT_PARAMETER_CONSTRAINTS_UPPERBOUND = float("inf")


DEFAULT_USE_MEASURED_TIMEPOINTS = False
DEFAULT_IDENTIFICATION_BACKEND = "nlscon"
