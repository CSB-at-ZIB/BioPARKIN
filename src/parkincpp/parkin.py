...
PARKINCPP_VERSION = _parkin.PARKINCPP_VERSION
PARKINCPP_DOTTED_VERSION = _parkin.PARKINCPP_DOTTED_VERSION
...
class ODESolver(_object):
    ...
    def setDebugFlag(self, *args): return _parkin.ODESolver_setDebugFlag(self, *args)
    def getDebugFlag(self): return _parkin.ODESolver_getDebugFlag(self)
...
class BioSystem(_object):
    ...
    def setSolverDebugFlag(self, *args): return _parkin.BioSystem_setSolverDebugFlag(self, *args)
