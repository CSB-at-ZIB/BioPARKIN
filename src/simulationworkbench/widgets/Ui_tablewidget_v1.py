...
# Form implementation generated from reading ui file '.\tablewidget_v1.ui'
#
# Created: Tue Feb 05 10:54:52 2013
...
class Ui_TableWidget(object):
    def setupUi(self, TableWidget):
        ...
        self.dataSourceTableView.setObjectName(_fromUtf8("dataSourceTableView"))
        ...
        self.groupBox_GeneralSettings.setObjectName(_fromUtf8("groupBox_GeneralSettings"))
        ...
        self.checkBoxShowUnits.setObjectName(_fromUtf8("checkBoxShowUnits"))
        ...
        self.checkBoxOrientation.setEnabled(False)
        self.checkBoxOrientation.setAutoFillBackground(True)
        self.checkBoxOrientation.setCheckable(False)
        self.checkBoxOrientation.setTristate(False)
        self.checkBoxOrientation.setObjectName(_fromUtf8("checkBoxOrientation"))
        ...
        self.groupBox_Coloring.setObjectName(_fromUtf8("groupBox_Coloring"))
        ...
        self.label_Coloring_Threshold.setObjectName(_fromUtf8("label_Coloring_Threshold"))
        ...
        self.doubleSpinBox_Coloring_Threshold.setObjectName(_fromUtf8("doubleSpinBox_Coloring_Threshold"))
        ...
        self.spinBox_Coloring_Exponent.setPrefix(_fromUtf8(""))
        self.spinBox_Coloring_Exponent.setMinimum(-99)
        self.spinBox_Coloring_Exponent.setProperty("value", 0)
        self.spinBox_Coloring_Exponent.setObjectName(_fromUtf8("spinBox_Coloring_Exponent"))
        ...
        self.buttonSaveTable.setObjectName(_fromUtf8("buttonSaveTable"))
        ...
        self.buttonSetExperimentalData.setObjectName(_fromUtf8("buttonSetExperimentalData"))
        ...
        self.tableWrapper.setEnabled(True)
        ...
        self.tableWrapper.setAutoFillBackground(True)
        self.tableWrapper.setObjectName(_fromUtf8("tableWrapper"))
        self.horizontalLayout.addWidget(self.splitter)
        self.actionSave = QtGui.QAction(TableWidget)
        self.actionSave.setObjectName(_fromUtf8("actionSave"))
        self.actionAddToExperimentalData = QtGui.QAction(TableWidget)
        self.actionAddToExperimentalData.setObjectName(_fromUtf8("actionAddToExperimentalData"))
        ...
        self.actionDeselectAll.setObjectName(_fromUtf8("actionDeselectAll"))
        ...
        QtCore.QObject.connect(self.buttonSetExperimentalData, QtCore.SIGNAL(_fromUtf8("clicked()")), self.actionAddToExperimentalData.trigger)
        QtCore.QObject.connect(self.buttonSelectAll, QtCore.SIGNAL(_fromUtf8("clicked()")), self.actionSelectAll.trigger)
        QtCore.QObject.connect(self.buttonDeselectAll, QtCore.SIGNAL(_fromUtf8("clicked()")), self.actionDeselectAll.trigger)
        QtCore.QObject.connect(self.buttonInvertSelection, QtCore.SIGNAL(_fromUtf8("clicked()")), self.actionInvertSelection.trigger)
        QtCore.QObject.connect(self.buttonSaveTable, QtCore.SIGNAL(_fromUtf8("clicked()")), self.actionSave.trigger)
