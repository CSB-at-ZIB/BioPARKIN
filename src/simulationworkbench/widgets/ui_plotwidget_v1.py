...
class Ui_PlotWidget(object):
    def setupUi(self, PlotWidget):
        ...
        self.verticalLayout_4 = QtGui.QVBoxLayout(PlotWidget)
        ...
        self.pageSources.setGeometry(QtCore.QRect(0, 0, 634, 549))
        self.pageSources.setObjectName("pageSources")
        self.verticalLayout_5 = QtGui.QVBoxLayout(self.pageSources)
        ...
        self.pageSettingsAndActions.setGeometry(QtCore.QRect(0, 0, 634, 549))
        ...
        self.checkBoxShowLegend = QtGui.QCheckBox(self.pageSettingsAndActions)
        ...
        self.checkBoxLogYAxis = QtGui.QCheckBox(self.pageSettingsAndActions)
        self.checkBoxLogYAxis.setObjectName("checkBoxLogYAxis")
        self.verticalLayout.addWidget(self.checkBoxLogYAxis)
        self.verticalLayout_2.addLayout(self.verticalLayout)
        self.buttonSavePlot = QtGui.QPushButton(self.pageSettingsAndActions)
    ...
    def retranslateUi(self, PlotWidget):
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.pageSources), QtGui.QApplication.translate("PlotWidget", "Sources", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.pageSettingsAndActions), QtGui.QApplication.translate("PlotWidget", "Settings and Actions", None, QtGui.QApplication.UnicodeUTF8))
